...
export async function generateMetadata({ params }: { params: Promise<{ page: string }> }): Promise<Metadata> { const page = findInformationPage((await params).page); return page ? { title: page.title, description: page.intro } : {}; }
