    ...
    <form id="partner-editor-form" className="partner-editor-form" onSubmit={submit}>
      <div className="partner-editor-main">
        <section className="partner-form-section"><header><b>1</b><h2>Personal Information</h2></header><div className="partner-field-grid">
          ...
          <label>Mobile Number *<div className="mobile-input"><span>+91</span><input name="mobile" required inputMode="numeric" pattern="[0-9]{10}" maxLength={10} title="Enter exactly 10 digits" value={mobile.replace(/^\+91/,"")} onChange={e=>setMobile(e.target.value.replace(/\D/g,"").slice(0,10))} placeholder="Enter 10-digit mobile number" disabled={editing}/></div></label>
