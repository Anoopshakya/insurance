    ...
    <section className="partner-growth">
      ...
      <div className="partner-growth-steps">
        <GrowthStep
          ...
          copy="Sell policies and get your regular reward."
          tone="blue"
        />
        <i>›</i>
        <GrowthStep
          ...
          copy="Invite partners and help them grow."
          tone="pink"
        />
        <i>›</i>
        <GrowthStep
      ...
      <div className="partner-growth-details">
        ...
        <div className="partner-commission-card">
          ...
          <article className="direct">
            ...
            <p>
              <strong>Direct Downline Team Partners</strong>
              <small>
          ...
          <article className="extended">
            ...
            <p>
              <strong>Extended Team Partners</strong>
              <small>
